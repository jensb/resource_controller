...
- This fork adds 
  ...
  - Rails 3 compatibility to the currently unmaintained {resource_controller}[http://github.com/jamesgolick/resource_controller]. You should use the original resource_controller for Rails 2 applications.
